...
|#13|Filtern der Angebote durch Suchradius
|#14|Filtern der Angeboten durch Kategorien
|#15|Verfall von Angeboten mit Verfallsdatum
|#16|Schreiben einer Nachricht an Angebotersteller
|#17|Anzeigen der Nachrichtenhistorie einer Konversation
|#18|Sperren eines Benutzeraccounts als Admin
|#19|Kategorie hinzufügen als Admin
|#20|Kategorie bearbeiten als Admin
|#21|Kategorie löschen als Admin
