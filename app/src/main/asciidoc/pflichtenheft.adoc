...
image:Bilddateien Pflichtenheft/Context.jpg[
"Kontextmodell",width=128,
link="Bilddateien Pflichtenheft/Context.jpg"]

=== Top-level architecture

image:Bilddateien Pflichtenheft/TLA.jpg[
"Top Level Architektur",width=128,
link="Bilddateien Pflichtenheft/TLA.jpg"]

== Anwendungsfälle

=== Überblick Anwendungsfalldiagramm
image:Bilddateien Pflichtenheft/usecase.jpg[
"Anwendungsfalldiagramm",width=128,
link="Bilddateien Pflichtenheft/usecase.jpg"]
...
image:Bilddateien Pflichtenheft/Registrierung.png[
"Registrierung",width=800,
link="Bilddateien Pflichtenheft/Registrierung.png"]

image:Bilddateien Pflichtenheft/Suchergebnisse.png[
"Suchergebnisse",width=800,
link="Bilddateien Pflichtenheft/Suchergebnisse.png"]

image:Bilddateien Pflichtenheft/Einstellungen.png[
"Einstellungen",width=800,
link="Bilddateien Pflichtenheft/Einstellungen.png"]

image:Bilddateien Pflichtenheft/Artikelseite.png[
"Artikelseite",width=800,
link="Bilddateien Pflichtenheft/Artikelseite.png"]
...
=== Überblick: Klassendiagramm
image:Bilddateien Pflichtenheft/classDiagram.jpg[
"Klassendiagramm",width=128,
link="Bilddateien Pflichtenheft/classDiagram.jpg"]
